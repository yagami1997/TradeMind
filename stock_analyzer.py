                ...
                <div class="manual-section">
                    ...
                    <div class="manual-grid">
                        ...
                        <div class="manual-card">
                            <h3>回测系统说明</h3>
                            <p>
                                • 总交易次数：系统在过去一年内触发的买卖信号总数，反映策略的活跃度<br>
                                • 整体胜率：盈利交易占总交易的百分比，衡量策略的准确性<br>
                                    - 胜率>60%：策略表现优秀<br>
                                    - 胜率50-60%：策略表现良好<br>
                                    - 胜率<50%：策略需要优化<br>
                                • 平均收益：每笔交易的平均收益百分比<br>
                                    - 计算方法：(所有交易收益之和)/总交易次数<br>
                                    - 正值表示策略整体盈利<br>
                                    - 负值表示策略整体亏损<br>
                                • 最大收益/损失：记录策略的极值表现<br>
                                    - 最大收益：单笔交易获得的最高收益率<br>
                                    - 最大损失：单笔交易承受的最大损失率<br>
                                    - 这两个指标帮助评估策略的风险收益比
                            </p>
                        </div>
                    </div>
