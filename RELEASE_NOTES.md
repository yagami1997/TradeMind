...
TradeMind Lite Beta 0.3.2是一个功能优化更新，主要聚焦于自选股导入功能的增强和用户体验改进。此版本优化了股票代码验证逻辑，增强了对指数和ETF的支持，并改进了用户界面交互体验，提高了系统整体稳定性。
...
2. 从源码安装: `git clone https://github.com/yourusername/trademind.git && cd trademind && pip install -e .`
