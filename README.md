...
<img width="1263" alt="image" src="https://github.com/user-attachments/assets/dd03d9bd-4c9b-453e-8334-3446b01b5014" />
1. 解决了MACD值显示错误的算法BUG，解决了一个不重要的告警提示；
2. 更新了股票决策的算法，目前操作结论偏积极，决策偏向布林带和RSI，这是我个人的偏好，大家可以根据自己偏好调整算法；
3. 改进了HTML的显示方式，采用大型卡片显示个股信息和操作指南，命令行分析完成之后，自动打开HTML报告，无需手动；
4. 优化改进了其他BUG；
